    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-rose-900 text-white">
            ...
            <div className="relative overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_40%,rgba(190,18,60,0.5),transparent_70%)]" />
                <div className="relative z-10 text-center py-20 px-6">
                    <div className="inline-flex items-center gap-3 px-6 py-3 bg-rose-700/30 backdrop-blur-sm rounded-full border border-rose-600/50 mb-6">
                        ...
                        <span className="text-rose-300 font-semibold">NOW PLAYING</span>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-6 pb-20">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {films.map((movie, index) => (
                        <div key={movie.id} className="group relative bg-gray-900/80 backdrop-blur-sm rounded-3xl overflow-hidden border border-gray-700 hover:border-rose-600 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 shadow-lg">
                            {/* Movie Poster */}
                            <div className="relative overflow-hidden">
                                <img 
                                    src={movie.poster} 
                                ...
                                <div className="absolute top-4 left-4">
                                    <div className="w-10 h-10 bg-gradient-to-r from-rose-700 to-rose-600 rounded-full flex items-center justify-center text-white font-bold">
                                        {index + 1}
                                    </div>
                                </div>
                                ...
                                <div className="absolute top-4 right-4">
                                    <div className="px-3 py-1 bg-rose-700/90 backdrop-blur-sm text-white text-xs font-bold rounded-full border border-rose-500/50">
                            ...
                            <div className="p-6">
                                ...
                                <div className="space-y-3 mb-6">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-gray-300">Duration: {movie.duration} min</span>
                                    </div>
                                </div>
                ...
                {films.length === 0 && (
                    <div className="text-center py-20">
                        ...
                        <h3 className="text-2xl font-bold text-rose-300 mb-2">No Movies Available</h3>
                        <p className="text-rose-400">Check back later for new releases!</p>
                    </div>
                )}
            </div>
        </div>
