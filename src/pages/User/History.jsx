            ...
            <div className="relative overflow-hidden">
                ...
                <div className="relative z-10 text-center py-16 px-6">
                    <div className="inline-flex items-center gap-3 px-6 py-3 bg-rose-500/20 backdrop-blur-sm rounded-full border border-rose-400/30 mb-6">
                        <Ticket className="text-rose-600" size={24} />
                        <span className="text-rose-700 font-semibold">BOOKING HISTORY</span>
                    </div>
                ...
                {orders.length > 0 ? (
                    <div className="space-y-6">
                        {orders.map((item, index) => (
                            <div
                                key={item.id}
                                className="group bg-white/70 backdrop-blur-sm rounded-3xl p-8 border border-rose-200 hover:border-rose-400 transition-all duration-500 transform hover:scale-105 shadow-lg"
                            >
                                <div className="flex flex-col lg:flex-row gap-6 items-start">
                                    ...
                                    <div className="flex flex-col items-center lg:items-end gap-4">
                                        ...
                                        <button className="group/btn flex items-center gap-2 bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white px-6 py-3 rounded-2xl font-bold transition-all duration-300 transform hover:scale-105">
                    ...
                    <div className="text-center py-20">
                        <div className="relative inline-block mb-8">
                            <div className="w-32 h-32 bg-gradient-to-r from-rose-500/20 to-pink-500/20 rounded-full flex items-center justify-center border border-rose-400/30">
                        ...
                        <h3 className="text-3xl font-bold text-rose-600 mb-4">No History Yet</h3>
                        <p className="text-gray-600 text-lg mb-2">Your cinema journey starts here!</p>
